...
// Куда ведёт каждая вкладка. Анубис получил свой экран 24.08.2026 — до
// этого маршрута у него не было, и карточка честно висела неактивной,
// хотя сам сторож (services/watchdog.py) работал с самого начала: просто
// показать его самочувствие было негде. Фаундер это и заметил.
