...
PRICES_PER_MTOK: dict[str, tuple[float, float]] = {
    ...
    # "latest" — плавающий алиас: 2.0-flash и следом 2.5-flash Google отозвал
    # в августе 2026 у этого ключа, поэтому фиксируем не версию, а алиас,
    # чтобы модель не протухла снова. Цена не перепроверена под новую модель.
